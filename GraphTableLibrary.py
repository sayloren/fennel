...
def graphTable(TableData,ranTableData,fileName):
	...
	ax0.set_yticks([])
	ax0.set_xticks([])
	Table0 = ax0.table(cellText=TableData.values,rowLabels=TableData.index,cellLoc='center',rowLoc='center',loc='center')
	...
	ax1.set_yticks([])
	ax1.set_xticks([])
	Table1 = ax1.table(cellText=ranTableData.values,rowLabels=ranTableData.index,cellLoc='center',rowLoc='center',loc='center')
